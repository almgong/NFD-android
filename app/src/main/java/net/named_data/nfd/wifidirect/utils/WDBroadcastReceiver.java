    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (WifiP2pManager.WIFI_P2P_STATE_CHANGED_ACTION.equals(action)) {
                        ...
                        for (String peerMacAddr : newPeers.keySet()) {
                            ...
                            if ((!connectedPeers.contains(device.deviceAddress)) &&
                                ...
                                if (mController.logConnectedPeer(peer)) {
                                    ...
                                    //connect(device);
                                    mController.connectToPeer(device);
                                } else {
            ...
            if (networkInfo.isConnected()) {
                ...
                mManager.requestConnectionInfo(mChannel, new WifiP2pManager.ConnectionInfoListener() {
                    ...
                    public void onConnectionInfoAvailable(WifiP2pInfo info) {
                        ...
                        if (info.groupFormed) {
                            ...
                            // stop peer discovery and connecting as we are now in a group
                ...
                // if a request to join a group failed, refresh some state for next attempt
                if (groupOwnerAddress == null) {
                    mController.getConnectedPeers().clear();
                    mController.startConnectQueue();
                }
            }
