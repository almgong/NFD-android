...
public class WDBroadcastReceiver extends BroadcastReceiver {
    ...
    public static volatile HashMap<String, WifiP2pDevice> availablePeers;
            ...
            if (mManager != null) {
                mManager.requestPeers(mChannel, new WifiP2pManager.PeerListListener() {
                    ...
                    public void onPeersAvailable(WifiP2pDeviceList peers) {
                        ...
                        // update publicly available peers map
                        for (WifiP2pDevice device: peers.getDeviceList()) {
                            availablePeers.put(device.deviceName, device);
                        }
...
//                        }
    ...
    /**
     * Convenience method to connect to a WifiP2p peer. Note: moved
     * for testing purposes to NDNController
